...
* Fedora Atomic or Bazzite<sup>3</sup> users please check the
...
<sup>3</sup> Bazzite support is limited to only problems with the utility, issues with channel splitting or other
GoXLR problems will not be addressed. Please see [here](https://github.com/GoXLR-on-Linux/goxlr-utility/issues/239) for
details.
